package com.dunya.stakechannel.accountsconsumer.config;
...
import com.dunya.stakechannel.accountsconsumer.service.AccountOperations;

@EnableKafka
@Configuration
public class AccountsConsumerConfiguration {

	@Value("${service.url.account}")
	private String accountsServiceUrl;

	@Value("${service.url.delegate}")
